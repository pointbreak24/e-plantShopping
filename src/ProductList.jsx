...
const handlePlantsClick = (e) => {
  ...
  //added here
    ...
    //handle add to cart button display
                    ...
                    <a href="#" onClick={(e) => handleCartClick(e)} style={styleA}>
                        <h1 className='cart'>
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 256" id="IconChangeColor" height="68" width="68">
                                ...
                                <text x="50%" y="50%" dominantBaseline="middle" textAnchor="middle" fill="#faf9f9" fontSize="64" fontWeight="bold">
                        {totalQuantity}
                    </text>
                            </svg>
                        </h1>
            ...
            <div key={index}>
                ...
                <div className="product-list">
                    ...
                    <div className="product-card" key={plantIndex}>
                        ...
                        <button
                                className="product-button"
                                onClick={() => isProductInCart(plant.name) ? handleRemoveFromCart(plant) : handleAddToCart(plant)}
                                disabled={isProductInCart(plant.name) && !cartItems.find(item => item.name === plant.name)}
                                style={{
                                        backgroundColor: isProductInCart(plant.name) ? 'gray' : 'green',
